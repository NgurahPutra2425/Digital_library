    ...
    <form action="./proses-update.php" class="flex flex-col relative justify-center items-center border border-[3px] border-black rounded-xl h-[60%] w-[40%] z-99" method="post">
        ...
        <div class="grid grid-cols-2 w-full px-2">
            ...
            <div class="flex flex-col text-left">
                ...
                <input type="text" name="nama" class="bg-blue-300 w-[95%] rounded-md placeholder:pl-2 placeholder:italic mb-4" value="<?php echo $d['NamaLengkap'] ?>" placeholder="Your Name" require>
            </div>
            <div class="flex flex-col text-left">
                <label for="username" class="w-full text-lg font-bold">Username</label>
                <input type="text" class="bg-blue-300 w-[95%] placeholder:px-2 rounded-lg mb-3" value="<?php echo $d['Username'] ?>" placeholder="Your Username" name="username" id="username" required>
            </div>
            <div class="flex flex-col text-left">
                <label for="alamat" class="w-full text-lg font-bold">Alamat</label>
                <input type="text" class="bg-blue-300 w-[95%] placeholder:px-2 rounded-lg mb-3" value="<?php echo $d['Alamat'] ?>" placeholder="Your Address" name="alamat" id="alamat" required>
            </div>
            <div class="flex flex-col text-left">
                <label for="email" class="w-full text-lg font-bold">E-mail</label>
                <input type="email" class="bg-blue-300 w-[95%] placeholder:px-2 rounded-lg mb-3" value="<?php echo $d['Email'] ?>" placeholder="Your E-mail" name="email" id="email" required>
            </div>
            <div class="flex flex-col text-left">
                <label for="pass" class="w-full text-lg font-bold">Password</label>
                <input type="password" class="bg-blue-300 w-[95%] placeholder:px-2 rounded-lg mb-3" value="<?php echo $d['Password'] ?>" placeholder="Your Password" name="pass" id="pass" required>
            </div>
            <div class="flex flex-col text-left">
                <label for="level" class="w-full text-lg font-bold">level</label>
                <select name="level" id="level" class="bg-blue-300 w-[95%] placeholder:px-2 rounded-lg mb-3" disabled>
